 ...
 <h1>Vendors</H1>                        
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <asp:SqlDataSource ID="dbStoreVendors" runat="server" ConnectionString="<%$ ConnectionStrings:connectionstringStoreDB %>" SelectCommand="SELECT VENDOR_CODE, VENDOR_NAME, VENDOR_CONTACT, VENDOR_AREACODE, VENDOR_PHONE, VENDOR_STATE, VENDOR_ORDER FROM Store.Vendor"></asp:SqlDataSource>
        </div>
    </div>
<div class="row">
<div class="col-lg-2">
