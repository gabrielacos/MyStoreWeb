...
class="table table-bordered" DataKeyNames="PRODUCT_CODE" DataSourceID="dssStoreProduct" OnSelectedIndexChanged="gvProducts_SelectedIndexChanged" OnPreRender="gvProducts_PreRender1">
     <Columns>
...
VENDOR_CODE FROM Store.Product
"></asp:SqlDataSource>
      </div>
</div>
<div class="row">
